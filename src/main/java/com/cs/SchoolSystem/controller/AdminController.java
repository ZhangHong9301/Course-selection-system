...
import com.cs.SchoolSystem.service.*;
import com.cs.SchoolSystem.service.impl.StudentServiceImpl;
...
public class AdminController {
    ...
    //修改学生信息页面显示
    @RequestMapping(name = "/editStudent",method = {RequestMethod.GET})
